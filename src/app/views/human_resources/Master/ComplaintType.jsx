...
const ComplaintType = ({ isMobile, isDarkMode, inputStyle }) => {
  ...
  const handleSave = () => {
    alert(`Saved ${JSON.stringify(formData)} for Complaint Type`);
    setFormData({});
  };
    ...
    <Box>
      ...
      <Paper elevation={2} sx={{ p: 2 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
          <Typography variant="h6">Complaint Type List</Typography>
          {isMobile && (
            <TablePagination
              component="div"
